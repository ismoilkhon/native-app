...
export const FeaturedCard = ({item: {image, address, price, rating, name}, onPress}: Props) => {
    return (
        <TouchableOpacity
        ...
        >
            ...
            <Image source={images.cardGradient} className='absolute rounded-2xl w-full h-full bottom-0' />
...
export const Card = ({item: {image, address, price, rating, name}, onPress}: Props) => {
    return (
        <TouchableOpacity 
